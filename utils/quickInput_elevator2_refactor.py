...
def main():
    ...
    JavaTools.generate_jar(java_dir="../oo_homework_2025_23373112_hw_6", # .java文件所在目录
                           output_filename="code.jar", 
                           external_jar_path="elevator2.jar", # 外部jar包路径
                           compile_output_dir="hw6/compile",
                           jar_output_dir="./", 
                           mode = mode)
    if (mode == 'mac'):
...
check, output = main()
if check == True:
    print(output + ": \033[32mAccepted!\033[0m")
else:
    print(output + ": \033[31mError occurred!\033[0m")